!function (o) {
    ...
    e.prototype.initCharts = function () {
        ...
        t && (e = t.split(","));
        var r = {
            chart: {height: 364, type: "line", dropShadow: {enabled: !0, opacity: .5, blur: 7, left: -7, top: 7}},
        ...
        0 < o("#world-map-markers").length && o("#world-map-markers").vectorMap({
            ...
            //         "stroke-width": 7,
            //         "stroke-opacity": .4
            //     }, hover: {stroke: "#fff", "fill-opacity": 1, "stroke-width": 3}
            // },
            focusOn: {
                x: 0.1,
                y: 0.5,
                scale: 0.1763475444023498
            },
            series: {
                regions: [{
                    values: {
                        "CA": "#666666", // 캐나다를 진한회색으로
                        "JP": "#666666", // 일본을 진한회색으로
                        "US": "#666666", // 미국을 진한회색으로
                        "GB": "#666666"  // 영국을 진한회색으로
                    }
                }]
            },
